               ...
               $(document).ready(function(){
			    ...
			    function editcat(val){
			    	//$('#edit').load('showcat');
			    		$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/showcat",
			   		'datatype':"json",
			   		'data' :{name:val},
			   		'success':function(data){
			   			//alert(data);
			    ...
			    function deletecat(c){
			    		...
			    		$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/delcat",
			   		'data' :{name:c},
			   		'success':function(data){
