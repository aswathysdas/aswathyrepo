		  ...
		  <script>
			...
			// });
			   		...
			   		'success':function(data){
			   			...
			   			$('#vv').empty();
							...
							for (var i = 0; i < dat.length; i++) {
								...
								toAppend+="<div class='grid_1_of_4 images_1_of_4 products-info'><img style='width:200px;height:280px;' src='<?php echo base_url(); ?>uploads/"+dat[i].vchr_product_img+"'> <a href='../welcome/singl/."+dat[i].pk_int_prdct_id+"'>"+dat[i].vchr_prdct_nm+"</a><h3>Rs."+dat[i].int_sell_price+"</h3><ul><li><button type='button' class='btn btn-info' value='"+dat[i].pk_int_prdct_id+"' onClick='prodbuy("+dat[i].pk_int_prdct_id+",\""+dat[i].int_sell_price+"\",\""+dat[i].int_quantity+"\")'>Buy Now</button></li></ul></div>";
							};
							$('#vv').append(toAppend);
			   		}
			   	});
			  ...
			  function prodbuy(bh,p,xw){
			  	...
			  	var quty=prompt("Enter the quantity",'1');
			  	//alert(quty);
			  	$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/Loginctrl/purchased",
			   		'datatype':"json",
			   		'data' :{name:bh,nm:quty,pric:p},
			   		'success':function(data){
			   			
			   				alert("your product will be received soon");
		...
		<div class="header">
			...
			<div class="header-top-nav">
				<ul>
					...
					<li id="del"><a href="logout">Logout</a></li>
	...
	<!--start-image-slider---->
		    ...
		    <div class="content">
				...
				<div class="grid_1_of_3 images_1_of_3" id="im1">
					  <a href="index.php/welcome/singl"><img style="width:480px;height:250px;" src="<?php echo base_url();?>images/images.jpg"></a>
				...
				<div class="grid_1_of_3 images_1_of_3 theree" id="im3">
					   <a href="single.html"><img style="width:480px;height:250px;" src="<?php echo base_url(); ?>images/samsunga7.jpg"></a>
					  <h3>Samsung A7</h3>
				</div>
			...
			<div class="section group">
		    	...
		    	<div class="content-sidebar">
		    		...
		    		<!-- <ul>
		    			<li id="catu"><a href="">Categories</a>
