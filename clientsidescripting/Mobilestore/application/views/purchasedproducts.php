		  ...
		  <script>
			...
			// });
			   ...
			   function editpro(p){
			   		$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/encodeproductedit",
			   		'datatype':"json",
			   		'data' :{name:p},
			   		'success':function(data){
			   			//alert(data);
			   ...
			   function delpro(k){
			   	alert(k);
			   		$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/deletingproduct",
			   		'datatype':"json",
			   		'data' :{name:k},
			   		'success':function(data){
			   			//alert(data);
