			...
			// });
			   ...
			   function show(){
			   	...
			   	//alert(v);
			   		$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/viewpc",
			   		'datatype':"json",
			   		'data' :{name:v},
			   		'success':function(data){
			   			//alert(data);
			   			$('#ct').empty();
							var dat= JSON.parse(data);
							//alert(dat[1].pk_int_sub_id);
							var toAppend="<tr><th>"+'SL No'+"</th><th>"+'Product Name'+"</th><th>"+'Description'+"</th><th>"+'Price'+"</th><th>"+'Selling Price'+"<th></th>"+'Quanity'+"</th></tr>";
							for (var i = 0; i <=dat.length-1; i++) {

								toAppend+="<tr><td>"+dat[i].pk_int_prdct_id+"</td><td>"+dat[i].vchr_prdct_nm+"</td><td>"+dat[i].vchr_desc+"</td><td>"+dat[i].int_price+"</td><td>"+dat[i].int_sell_price+"<td></td>"+dat[i].int_quantity+"</td></tr>";
							};
							$('#ct').append(toAppend);
			   		}
			   	});
	...
	<body>
		...
		<div class="header">
			...
			<div class="header-top-nav">
				<ul>
					<li id="lg"><a href="Loginctrl/logout">Logout</a></li>
				</ul>
			</div>
			<div class="clear"> </div>
		</div>
