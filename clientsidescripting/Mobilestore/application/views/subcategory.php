	...
	<body>
		...
		<div class="top-nav">
			<ul>
				...
				<li><a href="">Edit</a>
					<ul>
						<li><a href="../../index.php/Category_ctrl/editcat">Categories</a></li>
						<li><a href="../../index.php/Category_ctrl/vieweditsub">Sub-Categories</a></li>
						<li><a href="../../index.php/Category_ctrl/vieweditproduct">Products</a></li>
					</ul>

				</li>
				<li><a href="">View</a>
					<ul>
						<li><a href="../../index.php/regstrctrl">Categories</a></li>
						<li><a href="../../index.php/Category_ctrl/viewcust">Sub-Categories</a></li>
						<li><a href="../../index.php/Category_ctrl/suspendcust">Products</a></li>
					</ul>
        ...
        <!--start-image-slider---->
					<div class="wrap">
					  <div id="ctgry" style="padding:20px;">
					  	<div class="row">
					  		<div class="col-sm-offset-4 col-sm-5">
					  			<div class="panel panel-default">
					  				<div class="panel-heading">
					  					<span class="glyphicon glyphicon-list-alt"></span>  Sub-Category
					  				</div>
					  				<div class="panel-body">
					  					<form class="form-horizontal" method="post" action="subcat">
					  						<div class="form-group">
					  							<label for="category" class="col-sm-4 control-label">Category Name</label>
					  							<div class="col-sm-7">
					  								<select id="category" name="sub"><?php 
					  			    ...
					  			    ?></select>
					  						...
					  						<div class="form-group">
					  							<label for="subcatnm" class="col-sm-4 control-label">Sub-category Name</label>
					  							<div class="col-sm-7">
					  								<input id="subcatnm" type="text" placeholder="sub-category name" name="subcat" required>
					  							</div>
					  						</div>
