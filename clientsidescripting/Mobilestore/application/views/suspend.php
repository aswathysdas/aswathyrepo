		  ...
		  <script>
			...
			// });
			    ...
			    function sus(i){
			    	$.ajax({
			    	'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/custsuspension",
			   		'data' :{name:i},
					  			...
					  			<div class="panel panel-default">
					  				...
					  				<div class="panel-body">
					  					<table id="ct" class="table table-striped">
					  						...
					  						foreach ($cust as $row) {
					  							echo "<tr>";
					  							echo "<td>".++$c."</td><td>".$row->vchr_fname."</td><td>".$row->vchr_lname."</td><td>".$row->vchr_status."</td>";
					  							echo "<td><button type='submit' class='btn btn-link' value='".$row->pk_int_reg_id."' onClick='sus(this.value)'>Block</button></td>";
					  							echo "</tr>";
					  						}
					  						?>
					  					</table>
