		  ...
		  <script>
			...
			// });
			   ...
			   //	alert(v);
			   	$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/subonchng",
			   		'datatype':"json",
			   		'data' :{name:v},
			   		'success':function(data){
			   			//alert(data);
			   			$('#nm').empty();
							...
							for (var i = 0; i <=dat.length-1; i++) {
								...
								toAppend+="<tr><td>"+dat[i].pk_int_sub_id+"</td><td>"+dat[i].vchr_sub_categry_nm+"</td><td><button type='submit' class='btn btn-link' onclick='editsubcat(this.value)' value='"+dat[i].pk_int_sub_id+"'>Edit</button></td><td><button type='submit' onclick='delsubcate(this.value)' class='btn btn-link' value='"+dat[i].pk_int_sub_id+"'>Delete</button></td></tr>";
							};
							$('#nm').append(toAppend);
			   		}
			   	});
			   ...
			   function editsubcat(s){
			   	...
			   	$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/getsubshow",
			   		'datatype':"json",
			   		'data' :{name:s},
			   		'success':function(data){
			   			//alert(data);
			   ...
			   function delsubcate(sc){
			   	$.ajax({
			   		'type':"POST",
			   		'url' :"http://api.baabtra.com/Mobilestore_service/index.php/category_ctrl/delsubc",
			   		'datatype':"json",
			   		'data' :{name:sc},
			   		'success':function(data){
			   			//alert(data);
